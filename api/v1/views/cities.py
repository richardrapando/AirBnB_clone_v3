#!/usr/bin/python3
""" Objects handling cities RestFul API actions """
...
def get_cities(state_id):
    """
    List of cities objects of a specific
    State or specific city retrieved
    """
    list_cities = []
...
def get_city(city_id):
    """
    Specific city retrieved depending on the id
    """
...
def delete_city(city_id):
    """
    City deleted depending on the id
    """
    city = storage.get(City, city_id)
